...
//@Scope("prototype")
public class ScreenshotService_Passes_On_Parallel_Using_Prototype_Scope {

    Logger logger = LoggerFactory.getLogger(ScreenshotService_Passes_On_Parallel_Using_Prototype_Scope.class);

    @Autowired
    TakesScreenshot takesScreenshot; // We Will Fetch TakesScreenshot Bean From context As Per Our Need.
    ...
    public boolean takeScreenshot() {
        ...
        File _fileSrc = takesScreenshot.getScreenshotAs(OutputType.FILE);
        try {
