package com.example.seleniumspring.window;


import com.example.seleniumspring.base.SpringBaseTestNGTests;
import com.example.seleniumspring.pages.window.MainPage;
import com.example.seleniumspring.pages.window.PageA;
import com.example.seleniumspring.pages.window.PageB;
import com.example.seleniumspring.pages.window.PageC;
